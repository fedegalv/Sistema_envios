                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <asp:LoginView ID="LoginView1" runat="server">
                                ...
                                <LoggedInTemplate>
                                    <td>
                                        <a class="btn btn-secondary" href="Administracion/CambiarEstado.aspx?id=<%# Eval("IdPedido") %>&estado=<%# Eval("EstadoPedido")%>" role="button">Cambiar estado</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-secondary" href="Administracion/Eliminar.aspx?id=<%# Eval("IdPedido") %>" role="button">Eliminar</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-secondary" href="Administracion/Editar.aspx?id=<%# Eval("IdPedido") %>" role="button">Editar</a>
                                    </td>
                                </LoggedInTemplate>
                            </asp:LoginView>
